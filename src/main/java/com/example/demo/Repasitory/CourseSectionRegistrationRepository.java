// src/main/java/com/example/demo/repository/CourseSectionRegistrationRepository.java
...
public interface CourseSectionRegistrationRepository extends JpaRepository<CourseSectionRegistration, Long> {
    ...
    @Query("SELECT new com.example.demo.dto.ListDto.TermSummaryDto(t.id, t.title, " +
